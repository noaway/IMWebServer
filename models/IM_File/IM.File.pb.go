...
type IMFilePullDataReq struct {
	...
	TransMode        *IM_BaseDefine.FileType `protobuf:"varint,3,req,name=trans_mode,enum=IM.BaseDefine.FileType" json:"trans_mode,omitempty"`
...
func (m *IMFilePullDataReq) GetTransMode() IM_BaseDefine.FileType {
...
func (m *IMFilePullDataRsp) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *IMFileReq) GetTransMode() IM_BaseDefine.FileType {
	if m != nil && m.TransMode != nil {
		return *m.TransMode
	}
	return IM_BaseDefine.FileType_FILE_TYPE_ONLINE
...
type IMFileRsp struct {
	...
	TransMode        *IM_BaseDefine.FileType `protobuf:"varint,7,req,name=trans_mode,enum=IM.BaseDefine.FileType" json:"trans_mode,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
func (m *IMFileRsp) GetTransMode() IM_BaseDefine.FileType {
	if m != nil && m.TransMode != nil {
		return *m.TransMode
	}
	return IM_BaseDefine.FileType_FILE_TYPE_ONLINE
...
func (m *IMFileNotify) GetTransMode() IM_BaseDefine.FileType {
	if m != nil && m.TransMode != nil {
		return *m.TransMode
	}
	return IM_BaseDefine.FileType_FILE_TYPE_ONLINE
...
var fileDescriptor0 = []byte{
	...
	,
}
